...
public class ReadImgFile {
    private static final String TEST_IMAGE1_PATH = "/Users/Marwan/Desktop/cellmap/Task/data/PALM_532nm_gauss3d_d2.nrrd";

    public static < T extends NumericType< T > & NativeType< T >> void main(String[] args) throws IOException {
        File file = new File( TEST_IMAGE1_PATH );
        if (!file.exists())
